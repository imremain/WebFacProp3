<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formSucursal.aspx.cs" Inherits="WebFacturacion3.View.formSucursal" %>
...
<head runat="server">
    ...
    <script src="../Scripts/Views/formSucursal.js"></script>
            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
                <div class="container-fluid d-flex flex-column p-0">
                    <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                        ...
                        <div class="sidebar-brand-text mx-3"><span>Sucursales</span></div>
                    </a>
                    ...
                    <ul class="nav navbar-nav text-light" id="accordionSidebar">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link active" href="/View/formSucursal.aspx"><i class="fas fa-store"></i><span>Sucursal</span></a></li>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex justify-content-between align-items-center mb-4">
                            <h3 class="text-dark mb-0">Control de Sucursales</h3></div>
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-4">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h6 class="text-primary font-weight-bold m-0">Sucursales</h6>
                                        </div>
                                        <div class="card-body">
                                            <form id="form1" runat="server">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <asp:Label ID="lblId" runat="server" Text="ID de la Sucursal"></asp:Label>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtDireccion" runat="server"  MinLength="10" MaxLength="100" CssClass="form-control"></asp:TextBox>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group">
                                                        ...
                                                        <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" TargetControlID="btnIngresar" ConfirmText="Esta seguro que desea ingresar la sucursal?"/>
                                                        ...
                                                        <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender3" runat="server" TargetControlID="Actualizar" ConfirmText="Esta seguro que desea actualizar la sucursal?" />
                                                        
                                                    </div>
                                                </div>
                                                <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                                    <div class="form-group">
                                                        <asp:GridView ID="GridViewSucursal" runat="server" DataKeyNames="id_Sucursal, Nombre, Direccion, Telefono, id_Ciudad" OnPageIndexChanging="GridViewSucursal_PageIndexChanging" OnRowCancelingEdit="GridViewSucursal_RowCancelingEdit" OnRowCommand="GridViewSucursal_RowCommand" CssClass="table table-striped" HeaderStyle-CssClass="thead-dark">
                                                        <Columns>
